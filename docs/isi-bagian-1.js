...
module.exports = ({ h1, h2, h3, p, rich, quote, li, num, code, caption, table, br, gap }) => [
  ...
  table(
    ...
    [
      ...
      ['src/infrastructure/', 'Seluruh adapter ke layanan di seberang batas proses', 'database/, redis/, queue/, storage/', 'Logika fitur'],
      ['  database/', 'Koneksi PostgreSQL, definisi model, migration, seeder', 'index.js, models/, migrations/', 'Aturan bisnis'],
      ['  redis/, queue/, storage/', 'Koneksi ke Redis, RabbitMQ, dan MinIO', 'index.js masing-masing', 'Isi pesan, aturan validasi berkas'],
