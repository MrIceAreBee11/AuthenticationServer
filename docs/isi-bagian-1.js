...
module.exports = ({ h1, h2, h3, p, rich, quote, li, num, code, caption, table, br, gap }) => [
  ...
  table(
    ...
    [
      ...
      ['src/constants/', 'Data tetap yang tidak punya efek samping sama sekali', 'permissions.js', 'Apa pun yang membuka koneksi'],
      ...
      ['src/services/', 'Logika yang dipakai lintas fitur dan menyentuh penyimpanan', 'permission.service.js', 'Logika milik satu fitur saja'],
